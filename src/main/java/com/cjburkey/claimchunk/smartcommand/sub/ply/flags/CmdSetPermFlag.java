...
public class CmdSetPermFlag extends CCPlyAccessCmd {
    ...
    public CmdSetPermFlag(@NotNull ClaimChunk claimChunk, boolean isForPly, boolean isForChunk) {
    ...
    public @NotNull String getDescription() {
        ...
        if (isForPly) {
            if (isForChunk) {
                return msg.cmdPermFlagPlyChunkSet;
            } else {
                return msg.cmdPermFlagPlySet;
            }
        } else {
            if (isForChunk) {
                return msg.cmdPermFlagChunkSet;
            } else {
                return msg.cmdPermFlagGlobalSet;
            }
        }
    }
