...
public final class TitleHandler {
     ...
     * 
     * @param player
     *            The player to whom send the title.
     * @param text
     *            The text to display.
     * @param color
     *            The color.
     * @param fadeInTicks
     *            The fade in time in ticks.
     * @param stayTicks
     *            The stay time in ticks.
     * @param fadeOutTicks
     *            The fade out time in ticks.
     * @throws Exception
     *             Reflection error.
     */
     ...
     * 
     * @param player
     *            The player to whom send the subtitle.
     * @param text
     *            The text to display.
     * @param color
     *            The color.
     ...
     * 
     * @param player
     *            The player to whom send the actionbar title.
     * @param text
     *            The text to display.
     * @param color
     *            The color.
