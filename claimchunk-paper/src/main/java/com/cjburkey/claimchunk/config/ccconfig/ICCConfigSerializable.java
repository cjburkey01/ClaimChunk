...
/** Represents an object that may be serialized into and from a ClaimChunk config file. */
public interface ICCConfigSerializable {

    /**
     * Load the value at the provided key into this instance of this class, assuming it is possible.
     *
    ...
    /**
     * Stores this object's value at the particular key inside the provided ClaimChunk config.
     *
