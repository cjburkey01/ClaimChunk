...
[![Minecraft Version](https://img.shields.io/static/v1?label=Spigot&message=1.21.5&color=blueviolet&style=for-the-badge)](https://www.spigotmc.org/resources/claimchunk.44458/)
...
* **1.20-1.21.5+** | The latest version works seamlessly (excluding bugs, of course).
...
[![Version Info](https://img.shields.io/static/v1?label=Repository%20Version&message=1.0.0-SNAPSHOT1&color=ff5555&style=for-the-badge)](https://github.com/cjburkey01/ClaimChunk/archive/main.zip)
