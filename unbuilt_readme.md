...
[![Download Info](https://img.shields.io/static/v1?label=Spigot&message=@SPIGOT_VERSION@&color=blueviolet&style=for-the-badge)](https://www.spigotmc.org/resources/claimchunk.44458/)
...
* **1.8 - @SPIGOT_VERSION@** | Works seamlessly.
...
Building
--------
![Version Info](https://img.shields.io/static/v1?label=Repository%20Version&message=@PLUGIN_VERSION@&color=ff5555&style=for-the-badge)
